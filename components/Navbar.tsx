...
const Navbar = () => {
    return (
        <div className='w-full shadow-navbarShadow h-20 lg:-[12vh] stick top-0 z-50 bg-bodyColor px-4'>
            <div className='max-w-container h-full mx-auto p-1 font-titleFont flex items-center justify-between'>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.5 }}>
                    <Image className="w-14" src={navLogo} alt="logo" />
                </motion.div>
                    ...
                    <ul className="flex text-[13px] gap-7">
                        ...
                        <Link href="#project" className="flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <motion.li
                                ...
                                <span className="text-textGreen">02.</span>Project</motion.li>
                        </Link>
                        <Link href="#contact" className="flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <motion.li
                                ...
                                <span className="text-textGreen">03.</span>Contact</motion.li>
                        </Link>
                    </ul>
                    <a href="/assets/alec_cv.pdf" target="_blank">
                        <motion.button
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ duration: 0.5 }}
