        ...
        <div className="max-w-containerSmall mx-auto py-24 flex flex-col gap-8 px-4">
            ...
            <div className="flex gap-16">
                <div className="w-2/3 text-base text-textDark font-medium flex flex-col gap-4">
                    ...
                    <ul className="w-[450px] text-sm font-titleFont grid grid-cols-2 gap-2 mt-6">
                ...
                <div className="w-1/3 h-80 relative group">
                    <div className="absolute w-full h-80 -left-6 -top-6 rounded-lg">
                        <div className="w-full h-full relative z-20">
                            <Image
                                ...
                                alt="profileImg"
                            />
                            <div className="absolute w-full h-80 rounded-lg top-0 left-0 group-hover:bg-transparent duration-300"></div>
                        </div>
                    </div>
